const locale = {
  ...
  strategiespage: {
    ...
    sec3_desc_p1: "Existem 2 categorias de Estratégia:",
    sec3_desc_p2: "Básica e Avançada",
    sec3_desc_p3: "Uma para cada necessidade. Você também pode combina-las para tornar a sua Estratégia ainda mais eficiente.",
    sec3_desc_p4: "A Básica utiliza o conceito de comparação entre os indicadores vs preço.",
