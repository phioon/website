const locale = {
  ...
  strategiespage: {
    label_title: "Strategies Screener",

    desc_title: "Smart Technical Analysis",
    desc_p1: "The goal here is to optimize the way you look for opportunities that the market offers... So, we developed",
    desc_p2: "Strategies",
    desc_p3: "to save your most precious asset:",
    desc_p4: "time",

    sec1_infoarea1_title: "Strategy",
    sec1_infoarea1_desc: "The most famous setups in the market are already here. But you can also create new ones e contribute your way.",
    sec1_infoarea2_title: "Radar",
    sec1_infoarea2_desc: "Monitor all assets and easily identify those that are at the point of entry, or almost there!",
    sec1_infoarea3_title: "Results",
    sec1_infoarea3_desc: "When you start focusing only on the assets that really matter, the result is inevitable.",

    sec2_title: "Collaborative Environment",
    sec2_infoarea1_title: "Accelerate your Development",
    sec2_infoarea1_desc: "At PHIOON, the best strategies are given special places. So you are always one click away from the most efficient strategies on the market.",
    sec2_infoarea2_title: "Connect",
    sec2_infoarea2_desc: "Bring your friends with you! Share strategies and interact in a totally productive way.",
    sec2_infoarea3_title: "Unlimited Possibilities",
    sec2_infoarea3_desc: "You implement and review strategies, interact with other users, learn and share knowledge and much more...",

    sec3_title: "Stop surviving. Master it!",
    sec3_desc_p1: "In the financial market there are foreign investors, professional traders, companies, banks [...]",
    sec3_desc_p2: "In order to win on this battlefield, you need",
    sec3_desc_p3: "efficiency",
    sec3_desc_p4: "And to equalize the opportunities between traders and big players, PHIOON was born.",
    sec3_infoarea1_title: "Information Quality",
    sec3_infoarea1_desc: "Radar highlights assets that really deserve your attention. Trade without distractions!",
    sec3_infoarea2_title: "Focus",
    sec3_infoarea2_desc: "Do not get carried away by cognitive biases of the mind. PHIOON helps you to follow your Operational Plan.",
    sec3_infoarea3_title: "Consistency",
    sec3_infoarea3_desc: "It is the ability to execute a plan day after day. Make adjustments, calibrate expectations, but never abandon your Plan.",
    ...
    footer_title: "Ready to be more efficient in your technical analysis?",
